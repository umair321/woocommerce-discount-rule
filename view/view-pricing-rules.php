    ...
    <form id="form_price_rule">
        <div class="row-fluid">
            <div class="<?php echo $isPro ? 'col-md-12' : 'col-md-8'; ?>">
                ...
                <?php if ($rule_id == 0) { ?>
                    <div class="col-md-12">
                        <h2><?php esc_html_e('New Price Rule', 'woo-discount-rules'); ?></h2>
                    </div>
                <?php } else { ?>
                    <div class="col-md-12">
                        <h2><?php esc_html_e('Edit Price Rule', 'woo-discount-rules'); ?>
                            | <?php echo (isset($data->rule_name) ? $data->rule_name : ''); ?></h2>
                    </div>
                <?php } ?>
                <div class="col-md-12" id="general_block">
                    <h4 class="text text-muted"> <?php esc_html_e('General', 'woo-discount-rules'); ?></h4>
                    <hr>
                    <?php
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <input readonly type="number" class="rule_order" id="rule_order" name="rule_order" min=1 value="<?php echo (isset($data->rule_order) ? $data->rule_order : 1); ?>" placeholder="<?php esc_html_e('ex. 1', 'woo-discount-rules'); ?>">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-6"><input type="text" class="form-control rule_descr" id="rule_name" name="rule_name" value="<?php echo (isset($data->rule_name) ? $data->rule_name : ''); ?>" placeholder="<?php esc_attr_e('ex. Standard Rule.', 'woo-discount-rules'); ?>"></div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-6"><input type="text" class="form-control rule_descr" name="rule_descr" value="<?php echo (isset($data->rule_descr) ? $data->rule_descr : ''); ?>" id="rule_descr"></div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-6"><select class="form-control" name="rule_method" id="price_rule_method">
                                    <option value="qty_based" <?php if ($opt == 'qty_based') { ?> selected=selected <?php } ?>>
                                        <?php esc_html_e('Quantity / category / product / user role based discounts and BOGO deals ', 'woo-discount-rules'); ?>
                                    </option>
                                    <option disabled <?php if (!$pro) { ?> disabled <?php } else { ?> value="product_based" <?php
                                                                                                                        }
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-inline">
                                    <input type="text" name="date_from" class="form-control wdr_datepicker" value="<?php echo $date_from; ?>" placeholder="<?php esc_attr_e('From', 'woo-discount-rules'); ?>">
                                    <input type="text" name="date_to" class="form-control wdr_datepicker" value="<?php echo $date_to; ?>" placeholder="<?php esc_attr_e('To - Leave Empty if No Expiry', 'woo-discount-rules'); ?>"></div>
                        ...
                        ?>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-3"><label> <?php esc_html_e('Format for advanced table display option (see plugin settings)', 'woo-discount-rules'); ?> <i class="text-muted glyphicon glyphicon-exclamation-sign" title="<?php esc_attr_e('Used when advanced table display option is set in the plugin settings', 'woo-discount-rules'); ?>"></i></label></div>
                ...
                <div class="col-md-12 wdr_hide" id="restriction_block">
                    <h4 class="text text-muted"> <?php esc_html_e('Discount Conditions', 'woo-discount-rules'); ?></h4>
                    <hr>
                    <div class="qty_based_condition_cont price_discount_condition_con">
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-9"><select class="selectpicker" name="apply_to" id="apply_to">
                                        <option value="all_products" <?php if ($opt == 'all_products') { ?> selected=selected <?php } ?>>
                                            <?php esc_html_e('All products', 'woo-discount-rules'); ?>
                                        </option>
                                        <option disabled value="specific_products" <?php if ($opt == 'specific_products') { ?> selected=selected <?php } ?>>
                                            <?php esc_html_e('Specific products', 'woo-discount-rules'); ?>
                                        </option>
                                        <option disabled <?php if (!$pro) { ?> disabled <?php } else { ?> value="specific_category" <?php }
                                        ...
                                        <option disabled <?php if (!$pro) { ?> disabled <?php } else { ?> value="specific_attribute" <?php }
                                    ...
                                    <div class="form-group" id="cumulative_for_products_cont">
                                        <input type="checkbox" name="is_cumulative_for_products" id="is_cumulative_for_products" value="1" <?php if ($is_cumulative_for_products) {
                                                                                                                                                echo "checked";
                                                                                                                                            } ?>> <label class="checkbox_label" for="is_cumulative_for_products"><?php esc_html_e('Check this box to count item quantities in cart cumulatively across products', 'woo-discount-rules'); ?></label>
                                    </div>
                                    <div class="form-group" id="category_list">
                                        ...
                                        <select class="category_list selectpicker" multiple title="<?php esc_html_e('None selected', 'woo-discount-rules'); ?>" name="category_to_apply[]">
                                            <?php foreach ($category as $index => $value) { ?>
                                                <option value="<?php echo $index; ?>" <?php if (in_array($index, $category_list)) { ?> selected=selected <?php } ?>><?php echo $value; ?></option>
                                            <?php } ?>
                                        </select>
                                        <?php $is_cumulative = (isset($data->is_cumulative)) ? $data->is_cumulative : 1 ?>
                                        <input type="checkbox" name="is_cumulative" id="is_cumulative" value="1" <?php if ($is_cumulative) {
                                                                                                                        echo "checked";
                                                                                                                    } ?>> <label class="checkbox_label" for="is_cumulative"><?php esc_html_e('Check this box to count quantities cumulatively across category(ies)', 'woo-discount-rules'); ?></label>
                                        <div class="apply_child_categories">
                                            ...
                                            <input type="checkbox" name="apply_child_categories" id="apply_child_categories" value="1" <?php if ($apply_child_categories) {
                                                                                                                                            echo "checked";
                                                                                                                                        } ?>> <label class="checkbox_label" for="apply_child_categories"><?php esc_html_e('Check this box to apply child category(ies)', 'woo-discount-rules'); ?></label>
                                        </div>
                                    </div>
                                    <div class="form-group" id="product_attributes_list">
                                        ...
                                        <select class="attribute_list selectpicker" multiple title="<?php esc_html_e('None selected', 'woo-discount-rules'); ?>" name="attribute_to_apply[]">
                                            <?php foreach ($attributes as $index => $value) { ?>
                                                <option value="<?php echo $value['id']; ?>" <?php if (in_array($value['id'], $attribute_list)) { ?> selected=selected <?php } ?>><?php echo $value['text']; ?></option>
                                            <?php } ?>
                                        </select>
                                        <?php $is_cumulative_attribute = (isset($data->is_cumulative_attribute)) ? $data->is_cumulative_attribute : 1 ?>
                                        <div class="form-group">
                                            <input type="checkbox" name="is_cumulative_attribute" id="is_cumulative_attribute" value="1" <?php if ($is_cumulative_attribute) {
                                                                                                                                                echo "checked";
                                                                                                                                            } ?>> <label class="checkbox_label" for="is_cumulative_attribute"><?php esc_html_e('Check this box to count quantities cumulatively across attribute', 'woo-discount-rules'); ?></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        if ($pro) {
                                            ...
                                            <input type="checkbox" name="exclude_sale_items" id="exclude_sale_items" value="1" <?php if ($exclude_sale_items) {
                                                                                                                                    echo "checked";
                                                                                                                                } ?>> <label class="checkbox_label" for="exclude_sale_items"><?php esc_html_e('Check this box if the rule should not apply to items on sale.', 'woo-discount-rules'); ?></label>
                                        <?php
                                        } else {
                                        ?>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-9"><select class="selectpicker" name="customer" id="apply_customer">
                                        <option value="all" <?php if ($opt == 'all') { ?> selected=selected <?php } ?>>
                                            <?php esc_html_e('All', 'woo-discount-rules'); ?>
                                        </option>
                                        <option disabled <?php if (!$pro) { ?> disabled <?php } else { ?> value="only_given" <?php
                                                                                                                }
                                        ...
                                        <div class="form-group" id="based_on_purchase_history_fields">
                                            ...
                                            <select class="purchase_history_status_list selectpicker" multiple title="<?php esc_html_e('None selected', 'woo-discount-rules'); ?>" name="purchase_history_status_list[]">
                                                <?php foreach ($woocommerce_order_status as $index => $value) { ?>
                                                    <option value="<?php echo $index; ?>" <?php if (in_array($index, $purchase_history_status_list)) { ?> selected=selected <?php } ?>><?php echo $value; ?></option>
                                                <?php } ?>
                                            </select>
                    ...
                    <div class="product_based_condition_cont price_discount_condition_con">
                        ...
                        <div class="form-group" id="product_list">
                            ...
                            <div class="product_based_condition_get_product_discount get_discount_type_category_tag">
                                ...
                                <select class="category_list selectpicker" multiple title="<?php esc_html_e('None selected', 'woo-discount-rules'); ?>" name="product_based_condition[category_to_apply][]">
                                    <?php foreach ($category as $index => $value) { ?>
                                        <option value="<?php echo $index; ?>" <?php if (in_array($index, $product_based_condition_category_to_apply)) { ?> selected=selected <?php } ?>><?php echo $value; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                ...
                <div class="col-md-12 wdr_hide" id="discount_block">
                    ...
                    <div class="qty_based_discount_cont price_discounts_con">
                        <!-- <a href=javascript:void(0) class="button button-primary" id="addNewDiscountRange"><i class="glyphicon glyphicon-plus"></i>
                            <?php esc_html_e('Add New Range', 'woo-discount-rules'); ?>
                        </a> -->
                        <hr>
                                ...
                                <div class="discount_rule_list">
                                    <div class="form-group">
                                        <label><span class="discount_for_min_quantity_text"><?php esc_html_e('Min Quantity', 'woo-discount-rules'); ?></span>
                                            <input type="text" name="discount_range[<?php echo $fieldIndex; ?>][min_qty]" class="form-control discount_range_min_qty" value="<?php echo (isset($discount->min_qty) ? $discount->min_qty : ''); ?>" placeholder="<?php esc_html_e('ex. 1', 'woo-discount-rules'); ?>">
                                        </label>
                                        <label class="discount_for_max_quantity_label"><?php esc_html_e('Max Quantity', 'woo-discount-rules'); ?>
                                            <input type="text" name="discount_range[<?php echo $fieldIndex; ?>][max_qty]" class="form-control discount_range_max_qty" value="<?php echo (isset($discount->max_qty) ? $discount->max_qty : ''); ?>" placeholder="<?php esc_html_e('ex. 50', 'woo-discount-rules'); ?>"> </label>
                                        <label><?php esc_html_e('Adjustment Type', 'woo-discount-rules'); ?>
                                            <select class="form-control price_discount_type" name="discount_range[<?php echo $fieldIndex; ?>][discount_type]">
                                                <?php $opt = (isset($discount->discount_type) ? $discount->discount_type : ''); ?>
                                                <option value="percentage_discount" <?php if ($opt == 'percentage_discount') { ?> selected=selected <?php } ?>>
                                                    <?php esc_html_e('Percentage Discount', 'woo-discount-rules'); ?>
                                                </option>

                                                <option <?php if (!$pro) { ?> disabled <?php } else { ?> value="price_discount" <?php
                                                                                                                            }
                                                ...
                                                <option <?php if (!$pro) { ?> disabled <?php } else { ?> value="fixed_price" <?php
                                                                                                                            }
                                                ...
                                                <option <?php if (!$pro) { ?> disabled <?php } else { ?> value="set_discount" <?php
                                                                                                                            }
                                                ...
                                                <option <?php if (!$pro) { ?> disabled <?php } else { ?> value="product_discount" <?php
                                                                                                                                }
                                        ...
                                        <label><span class="hide-for-product-discount"><?php esc_html_e('Value', 'woo-discount-rules'); ?></span>
                                            <input type="text" name="discount_range[<?php echo $fieldIndex; ?>][to_discount]" class="form-control price_discount_amount" value="<?php echo (isset($discount->to_discount) ? $discount->to_discount : ''); ?>" placeholder="<?php esc_attr_e('ex. 50', 'woo-discount-rules'); ?>">
                                            ...
                                            <div class="price_discount_product_list_con">
                                                ...
                                                <div class="discount_product_option_bogo_con hide">
                                                    <label><?php esc_html_e('Free quantity', 'woo-discount-rules'); ?> <span class="woocommerce-help-tip" data-tip="<?php esc_attr_e('Number of quantity(ies) in each selected product(s)', 'woo-discount-rules'); ?>"></span>
                                                        <input type="text" name="discount_range[<?php echo $fieldIndex; ?>][discount_bogo_qty]" class="form-control discount_bogo_qty" value="<?php echo (isset($discount->discount_bogo_qty) ? $discount->discount_bogo_qty : 1); ?>" placeholder="<?php esc_attr_e('ex. 1', 'woo-discount-rules'); ?>" />
                                                    </label>
                                                </div>
                                                <div class="discount_product_option_more_cheapest_con hide">
                                                    ...
                                                    <label class="discount_product_items_count_field"><?php esc_html_e('Item count', 'woo-discount-rules'); ?> <span class="woocommerce-help-tip" data-tip="<?php esc_attr_e('Discount for number of item(s) in cart', 'woo-discount-rules'); ?>"></span>
                                                        <input type="text" name="discount_range[<?php echo $fieldIndex; ?>][discount_product_items]" class="form-control discount_product_items_count_field" value="<?php echo (isset($discount->discount_product_items) ? $discount->discount_product_items : ''); ?>" placeholder="<?php esc_attr_e('ex. 1', 'woo-discount-rules'); ?>" />
                                                    </label>
                                                    <label><?php esc_html_e('Item quantity', 'woo-discount-rules'); ?> <span class="woocommerce-help-tip" data-tip="<?php esc_attr_e('Discount for number of quantity(ies)', 'woo-discount-rules'); ?>"></span>
                                                        <input type="text" name="discount_range[<?php echo $fieldIndex; ?>][discount_product_qty]" class="form-control discount_product_qty" value="<?php echo (isset($discount->discount_product_qty) ? $discount->discount_product_qty : ''); ?>" placeholder="<?php esc_attr_e('ex. 1', 'woo-discount-rules'); ?>" />
                                                    </label>
                                                </div>
                                                ...
                                                <div class="discount_category_option_list_con hide">
                                                    ...
                                                    <label><span class="wdr_block_span"><?php esc_html_e('Choose category(ies)', 'woo-discount-rules'); ?></span>
                                                        <select class="category_list selectpicker" multiple title="<?php esc_html_e('None selected', 'woo-discount-rules'); ?>" name="<?php echo "discount_range[" . $fieldIndex . "][discount_category][]"; ?>">
                                                            <?php foreach ($category as $index => $value) { ?>
                                                ...
                                                <div class="discount_product_percent_con hide">
                                                    ...
                                                    <span class="discount_product_percent_field">
                                                        <input type="text" name="discount_range[<?php echo $fieldIndex; ?>][discount_product_percent]" class="discount_product_percent_field" value="<?php echo (isset($discount->discount_product_percent) ? $discount->discount_product_percent : ''); ?>" placeholder="<?php esc_attr_e('ex. 10', 'woo-discount-rules'); ?>" /><span class="woocommerce-help-tip" data-tip="<?php esc_attr_e('Enter only numeric values. Eg: <b>50</b> for 50% discount', 'woo-discount-rules'); ?>"></span>
                                                    </span>
                                                </div>
                                            </div>
                                        </label>
                                        <!-- <label>
                                            <a href=javascript:void(0) class="btn btn-danger form-control remove_discount_range"><?php esc_html_e('Remove', 'woo-discount-rules'); ?></a>
                                        </label> -->
                                        <!-- <label>
                                            <a href="javascript:void(0)" data-id="<?php echo $fieldIndex; ?>" class="btn btn-primary form-control create_duplicate_discount_range"><?php esc_html_e('Duplicate', 'woo-discount-rules'); ?></a>
                                        </label> -->
